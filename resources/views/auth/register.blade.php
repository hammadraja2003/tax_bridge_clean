            ...
            <div class="col-xxl-12">
                <div class="card">
                    <div class="card-header d-flex justify-content-between align-items-center">
                        <h5 class="mb-0">Basic Configuration Form</h5>
                    </div>
                    <div class="card-body">
                        <form class="app-form needs-validation" novalidate action="{{ route('admin.register') }}"
                            method="POST" enctype="multipart/form-data">
                            @csrf
                            <div class="form-wizard">
                                <div class="row">
                                    <div class="col-xl-3 mb-3">
                                        <div class="nav navstpes flex-column step-nav p-3 rounded shadow-sm" id="Basic"
                                            role="tablist">
                                            <button class="nav-link active d-flex align-items-center mb-2"
                                                id="v-features-tab" data-bs-toggle="tab"
                                                ...
                                                <div class="row g-3">
                                                    ...
                                                    <div class="col-md-4">
                                                        ...
                                                        <select name="id_type" id="id_type"
                                                            ...
                                                            <option value="CNIC"
                                                                {{ old('id_type') === 'CNIC' ? 'selected' : '' }}>CNIC
                                                            </option>
                                                        </select>
                                                        <div class="invalid-feedback">
                                                            @error('id_type')
                                                    ...
                                                    <div class="col-md-4">
                                                        <label for="bus_province"
                                                            class="form-label required">Province</label>
                                                    ...
                                                    <div class="col-md-6">
                                                        ...
                                                        <select name="scenario_ids[]" id="scenario_ids"
                                                            ...
                                                            @foreach ($scenarios as $scenario)
                                                                <option value="">Select Your Scenarios</option>
